package net.com.diagnose.ldn.Task;
...
import net.com.diagnose.ldn.LDNetDiagnoService.LDNetDiagnoListener;
import net.com.diagnose.ldn.LDNetDiagnoService.LDNetDiagnoService;
import net.com.diagnose.utils.DeviceUtils;
...
public class TraceTask extends BaseTask implements LDNetDiagnoListener {
    ...
    public TraceTask(Activity context, String url, TextView resultTextView, Logurl logurl) {
        super(url, resultTextView);
        this.context = context;
        this.url = url;
        this.resultTextView = resultTextView;
